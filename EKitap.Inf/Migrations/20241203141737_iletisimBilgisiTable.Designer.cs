...
namespace EKitap.Inf.Migrations
{
    ...
    [Migration("20241203141737_iletisimBilgisiTable")]
    partial class iletisimBilgisiTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EKitap.Dom.Models.IletisimBilgisi", b =>
                {
                    b.Property<int>("IletisimBilgiID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IletisimBilgiID"));
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 3, 17, 17, 35, 737, DateTimeKind.Local).AddTicks(6709));
            ...
            modelBuilder.Entity("EKitap.Dom.Models.YayinEvi", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 17, 17, 35, 828, DateTimeKind.Local).AddTicks(9892));
            ...
            modelBuilder.Entity("EKitap.Dom.Models.Yazar", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 17, 17, 35, 829, DateTimeKind.Local).AddTicks(3586));
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Kategori", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 17, 17, 35, 738, DateTimeKind.Local).AddTicks(3238));
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Kitap", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 17, 17, 35, 738, DateTimeKind.Local).AddTicks(8025));
            ...
            modelBuilder.Entity("EKitap.Domain.Models.KitapYazar", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 17, 17, 35, 739, DateTimeKind.Local).AddTicks(4619));
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Kullanici", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Ad = "Bilge",
                            ConcurrencyStamp = "adaebcff-d06b-4a19-a7ec-564729b3ce63",
                            Email = "bilgeadam@deneme.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "BILGEADAM@DENEME.COM",
                            NormalizedUserName = "BLGADM",
                            PasswordHash = "AQAAAAIAAYagAAAAEJK2m9b4sWEbTTu6GY59cN4ifaTA7wVJIvJquwD+6JGwMFX5cPWzjEfs/4WITRQrtg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "404f9af7-2b07-4704-bb70-25cb61724b9f",
                            Soyad = "Adam",
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Rol", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "d5036718-375f-43c6-8894-9ed8de691207",
                            Name = "Yonetici",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "0043c480-c3f6-4182-b172-e3f594e75864",
                            Name = "Kullanici",
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Sepet", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 17, 17, 35, 828, DateTimeKind.Local).AddTicks(5516));
