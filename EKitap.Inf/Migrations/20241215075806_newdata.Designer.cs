...
namespace EKitap.Inf.Migrations
{
    ...
    [Migration("20241215075806_newdata")]
            ...
            modelBuilder.Entity("EKitap.Dom.Models.IletisimBilgisi", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 15, 10, 58, 4, 619, DateTimeKind.Local).AddTicks(6954));
            ...
            modelBuilder.Entity("EKitap.Dom.Models.YayinEvi", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 15, 10, 58, 4, 669, DateTimeKind.Local).AddTicks(2236));
            ...
            modelBuilder.Entity("EKitap.Dom.Models.Yazar", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 15, 10, 58, 4, 669, DateTimeKind.Local).AddTicks(4662));
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Kategori", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 15, 10, 58, 4, 619, DateTimeKind.Local).AddTicks(9167));
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Kitap", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 15, 10, 58, 4, 620, DateTimeKind.Local).AddTicks(992));
            ...
            modelBuilder.Entity("EKitap.Domain.Models.KitapYazar", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 15, 10, 58, 4, 620, DateTimeKind.Local).AddTicks(3349));
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Kullanici", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Ad = "Bilge",
                            ConcurrencyStamp = "189a7a59-c5ae-4a3c-a77a-d02f7f9c4dad",
                            Email = "bilgeadam@deneme.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "BILGEADAM@DENEME.COM",
                            NormalizedUserName = "BLGADM",
                            PasswordHash = "AQAAAAIAAYagAAAAEJfuo5NsJIbOjVxHw0c59xEAwg5AW2/PrQNy5aBK9xudAnwbaNHp7HLoQqvWAv0vag==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a6589249-75f7-4858-9660-c307e6ee567e",
                            Soyad = "Adam",
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Rol", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "c9699fe6-3914-47f3-8f59-89f0c754cc46",
                            Name = "Yonetici",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "294b30b1-8cd5-4e09-a52b-f1f0b0b97316",
                            Name = "Kullanici",
            ...
            modelBuilder.Entity("EKitap.Domain.Models.Sepet", b =>
                {
                    ...
                    b.Property<DateTime>("EklenmeTarihi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2024, 12, 15, 10, 58, 4, 668, DateTimeKind.Local).AddTicks(8141));
